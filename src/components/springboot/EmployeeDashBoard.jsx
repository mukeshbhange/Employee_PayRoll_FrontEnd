                            ...
                            employees.length > 0 &&
                                employees.map((employee, index) => {
                                    return <tr key={`${index}`}>
                                        ...
                                        <td className="text-left"> <img src={employee.profilePic} className="profile_img mr-2" /></td>
                                        <td>{employee.name}</td>
                                        ...
                                        <td>{employee.note}</td>
                                    <td>
                                        <Link to={`edit/${employee.employeeId}`}><button  type="button" className="btn btn-warning">Edit</button></Link>
                                        <button type="button" onClick={() => deleteEmployee(employee.employeeId)} className="btn btn-danger">Delete</button>
                                    </td>
                                    </tr>
                                })
